...
class DatabaseManagementService
{
    ...
    public function createBackup(): string
    {
        ...
        if ($this->tryMysqldumpBackup($filepath)) {
            return $filename;
        }
     ...
     */
    private function tryMysqldumpBackup(string $filepath): bool
    {
        ...
        foreach ($mysqldumpPaths as $mysqldump) {
            ...
            if ($returnCode === 0 && file_exists($filepath) && filesize($filepath) > 0) {
                \Log::info('Backup created using mysqldump (MySQL Workbench method)');
                return true;
            }
        }
    ...
    private function generateSqlDump(): string
    {
        ...
        $sql .= "-- Similar to MySQL Workbench export\n\n";
